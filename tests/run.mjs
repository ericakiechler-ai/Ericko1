...
const suites = ['tests/ed25519.test.mjs', 'tests/app.test.mjs', 'tests/850.test.mjs', 'tests/869.test.mjs', 'tests/889.test.mjs', 'tests/7sj85.test.mjs', 'tests/7sd82.test.mjs'];
let bad = 0;
